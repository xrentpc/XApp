...
const config = [
  { name: "STANDART", price: 1550, img: "images/config_1.png" },
  { name: "PREMIUM", price: 1955, img: "images/config_2.png" },
  { name: "X", price: 2450, img: "images/config_3.png" },
  { name: "COMPACT", price: 1660, img: "images/config_4.png" }
];
...
function renderCatalog() {
  ...
  config.forEach(cfg => {
    ...
    button.onclick = () => alert("Форма заказа появится позже 😉");
